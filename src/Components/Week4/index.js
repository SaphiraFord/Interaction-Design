...
const schema = yup.object().shape({
  email: yup.string().required("Invalid Phone number/Email!").email("Not a valid email"),
...
const Week4 = () => {
  ...
  if(errors.password || errors.email){
    ...
    document.getElementById("email").style.cssText = "border-bottom: 2px solid red; color: red";
    document.getElementById("txt_label1").style.cssText = "color: red";

    document.getElementById("password").style.cssText = "border-bottom: 2px solid red; color: red";
    document.getElementById("txt_label2").style.cssText = "color: red";

    document.getElementById("eyeIcon").style.cssText = "filter: invert(596%) sepia(91%) saturate(2804%) hue-rotate( 332deg) brightness(77%) contrast(486%)";
  ...
  return (
    <StyledWrapper>
      ...
      <StyledHeader2> Sign up to let your cat<br /> play our activites </StyledHeader2>
      <br />
      {submitted}
      {!submitted && (
      ...
      <form onSubmit={handleSubmit(onSubmit)} >
        ...
        <label>
          <StyledLabel id="txt_label1">Phone number/Email</StyledLabel>
          <StyledInput id="email" autoFocus type="text" name="email" placeholder="Phone number/Email" ref={register()}/>
          <StyledErrorText> {errors.email?.message}</StyledErrorText>
        </label>
        <br /> 
        
        <StyledIcon id="eyeIcon"
          src={showPassword ? hideIcon : showIcon}
          onClick={handleClick}
        ></StyledIcon>

        <label> 
          <StyledLabel id="txt_label2" onfocus>Password</StyledLabel>
          <StyledInput id="password" type={showPassword ? "text" : "password"} name="password"  placeholder="Password" ref={register()}/>
        </label>
